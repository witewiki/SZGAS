				...
				<div id="page-wrapper">
	                ...
	                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
	                    ...
	                    <ol class="breadcrumb page-breadcrumb">
	                        ...
	                        <li><i class="fa fa-tint"></i>&nbsp;<a href="#">积分规则</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
	                        <li class="active"><i class="fa fa-tasks"></i>&nbsp;规则管理</li>
	                    </ol>
	                    <div class="clearfix"></div>
	                </div>
	                                        ...
	                                        <table id="example1" style="border-bottom:1px solid #ddd" class="table table-striped table-bordered table-hover text-center">
	                                            ...
	                                            <tbody>
	                                                <tr class="odd gradeX">
	                                                    ...
	                                                    <td><span class="label label-sm label-success">生效</span></td>
	                                                    <td>
	                                                ...
	                                                <tr class="odd gradeX">
	                                                    ...
	                                                    <td><a href="javascript:;">查看</a></td>
	                                                    <td>2015-05-01 22:23</td>
	                                                    <td><span class="label label-sm label-grey">未生效</span></td>
	                                                    <td>
