				...
				<div id="page-wrapper">
	                ...
	                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
	                    ...
	                    <ol class="breadcrumb page-breadcrumb">
	                        ...
	                        <li><i class="fa fa-flask"></i>&nbsp;<a href="#">管气道业务管理</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
	                        <li class="active"><i class="fa fa-group"></i>&nbsp;预约</li>
	                    </ol>
	                    <div class="clearfix"></div>
	                </div>
	                                ...
	                                <div class="portlet-body">
	                                    <div class="table-responsive">
	                                        <table id="example1" style="border-bottom:1px solid #ddd" class="table table-striped table-bordered table-hover text-center">
	                                            <thead>
	                                                <tr>
	                                                    <td><strong>用户帐户</strong></td>
	                                                    <td><strong>客户编码</strong></td>
	                                            ...
	                                            <tbody>
	                                                <tr class="odd gradeX">
	                                                    ...
	                                                    <td><span class="label label-sm label-info">已预约</span></td>
	                                                    <td>
	                                                    	<a href="javascript:;" class="delete">预约时间</a>&nbsp;
	                                                    </td>
	                                                </tr>
	                                                <tr class="odd gradeX">
	                                                    <td>zhangsan112</td>
	                                                    <td>A25C13CDZ</td>
	                                                    <td class="center">2015-01-01 13:11</td>
	                                                    <td><span class="label label-sm label-warning">待预约</span></td>
	                                                    <td>
	                                                    	<a href="javascript:;" class="delete">预约</a>&nbsp;
	                                                    	<a href="javascript:;" class="delete">预约时间</a>
	                                                    </td>
	                                                </tr>
	                                                <tr class="odd gradeX">
	                                                    ...
	                                                    <td>A25C13CDZ</td>
	                                                    <td class="center">2015-01-01 13:11</td>
	                                                    <td><span class="label label-sm label-success">已上门</span></td>
	                                                    <td>
