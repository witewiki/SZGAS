				...
				<div id="page-wrapper">
	                ...
	                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
	                    <div class="page-header pull-left">
	                        <div class="page-title">收集建议</div>
	                    </div>
	                    <ol class="breadcrumb page-breadcrumb">
	                        <li><i class="fa fa-home"></i>&nbsp;<a href="../home/home.html">主页</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
	                        <li><i class="fa fa-frown-o"></i>&nbsp;<a href="#">投诉建议管理</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
	                        <li class="active"><i class="fa fa-hand-o-right"></i>&nbsp;收集建议</li>
	                    </ol>
	                    <div class="clearfix"></div>
	                </div>
	                                        ...
	                                        <table id="example1" style="border-bottom:1px solid #ddd" class="table table-striped table-bordered table-hover text-center">
	                                            ...
	                                            <tbody>
	                                                <tr class="odd gradeX">
	                                                    <td>lisi</td>
	                                                    <td>希望能降价!</td>
	                                                    <td>2015-05-01 22:23</td>
	                                                    <td><span class="label label-sm label-success">采纳</span></td>
	                                                    <td>
	                                                ...
	                                                <tr class="odd gradeX">
	                                                    ...
	                                                    <td>希望能降价!</td>
	                                                    <td>2015-05-01 22:23</td>
	                                                    <td><span class="label label-sm label-grey">未采纳</span></td>
	                                                    <td>
	                                                    	<a href="javascript:;">采纳</a>&nbsp;
	                                                    </td>
	                                                </tr>
	                                            </tbody>
	                                        </table>
