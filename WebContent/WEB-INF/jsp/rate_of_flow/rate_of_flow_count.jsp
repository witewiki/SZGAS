...
<html lang="en">
	...
	<body class=" ">
				...
				<div id="page-wrapper">
	                ...
	                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
	                    ...
	                    <ol class="breadcrumb page-breadcrumb">
	                        ...
	                        <li class="active"><i class="fa fa-random"></i>&nbsp;业务统计</li>
	                    </ol>
	                    <div class="clearfix"></div>
	                </div>
	                        ...
	                        <div class="col-lg-12">
	                            <div class="portlet box">
	                                ...
	                                <div class="portlet-body">
	                                    <div id="spline-updating-each-second"></div>
	                                </div>
	                            </div>
	                            <div class="portlet box">
	                                <div class="portlet-header">
	                                    <div class="caption">当天注册人数</div>
	                                    <div class="tools">
	                                    	<i class="fa fa-chevron-up"></i>
	                                    	<i data-toggle="modal" data-target="#modal-config" class="fa fa-cog"></i>
	                                    	<i class="fa fa-refresh"></i>
	                                ...
	                                <div class="portlet-body">
	                                    <div id="with-data-labels" data-highcharts-chart="1"></div>
	                                </div>
	                            </div>
	                            <div class="portlet box">
	                                <div class="portlet-header">
	                                    <div class="caption">访问量</div>
	                                    <div class="tools">
	                                    	<i class="fa fa-chevron-up"></i>
	                                    	<i data-toggle="modal" data-target="#modal-config" class="fa fa-cog"></i>
	                                    	<i class="fa fa-refresh"></i>
	                                ...
	                                <div class="portlet-body">
	                                    <div id="spline-with-symbols" data-highcharts-chart="3"></div>
	                                </div>
	                            </div>
	                        </div>
	                    </div>
    	...
    	<script src="../../js/charts-highchart-dynamic.js"></script>
		<!--
		 	作者：zhijie_94@163.com
		 	时间：2015-06-12
			描述：这个是higchart的写的测试数据图
		-->
    	<script src="../../js/charts-highchart-line.js"></script>
	</body>
