				...
				<div id="page-wrapper">
	                ...
	                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
	                    <div class="page-header pull-left">
	                        <div class="page-title">燃气服务点管理</div>
	                    </div>
	                    <ol class="breadcrumb page-breadcrumb">
	                        ...
	                        <li class="active"><i class="fa fa-globe"></i>&nbsp;燃气服务点管理</li>
	                    </ol>
	                    <div class="clearfix"></div>
	                </div>
	                                        ...
	                                        <table id="example1" style="border-bottom:1px solid #ddd" class="table table-striped table-bordered table-hover text-center">
	                                            ...
	                                            <tbody>
	                                                <tr class="odd gradeX">
	                                                    ...
	                                                    <td><span class="label label-sm label-success">服务点可用</span></td>
	                                                    <td>
	                                                ...
	                                                <tr class="odd gradeX">
	                                                    ...
	                                                    <td>a路, b路, c路</td>
	                                                    <td><a href="javascript:;">显示</a></td>
	                                                    <td><span class="label label-sm label-warning">服务点搬迁</span></td>
	                                                    <td>
	                                                    	<a href="javascript:;">编辑</a>&nbsp;
	                                                    	<a href="javascript:;">删除</a>
	                                                    </td>
