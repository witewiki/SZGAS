				...
				<div id="page-wrapper">
	                ...
	                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
	                    ...
	                    <ol class="breadcrumb page-breadcrumb">
	                        ...
	                        <li class="active"><i class="fa fa-plus-square-o"></i>&nbsp;新增资讯</li>
	                    </ol>
	                    <div class="clearfix"></div>
	                </div>
	                                ...
	                                <div class="portlet box portlet-white">
	                                    <div class="portlet-body">
	                                        <form role="form-horizontal" method="post">
	                                            ...
	                                            <div class="form-group">
	                                                <div class="input-group">
	                                                	<span class="input-group-addon">资讯类别:</span>
	                                                    <select id="add_role_form_status_select" class="select2"  style="width:50%;">
			                                            	<option selected>请选择资讯类别</option>
			                                            	<option>科谱</option>
			                                            	<option>新闻</option>
			                                            </select>
	                                                </div>
	                                            ...
	                                            <div class="form-group">
	                                                <div class="input-group">
	                                                	<span class="input-group-addon">&nbsp;&nbsp;发布到:</span>
	                                                    <select id="add_role_form_status_select" class="select2"  style="width:50%;">
			                                            	<option selected>请选择版块</option>
			                                            	<option>燃气公告版块</option>
			                                            	<option>知识宣传版块</option>
			                                            </select>
	                                                </div>
	                                            </div>
	                                            ...
	                                            <hr/>
	                                            <div class="col-lg-6" >
	                                            	<a href="javascript:history.go(-1);" class="btn btn-default btn-square">返回<a>
	                                            </div>
	                                            <div class="compose-btn navbar-right">
	                                                <button type="button" class="btn btn-success btn-square">发布资讯</button>
	                                            </div>
	                                            <div class="clearfix"></div>
	                                        </form>
	                                    </div>
