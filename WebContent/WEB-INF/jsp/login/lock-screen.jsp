...
<body id="lock-screen-page">
    <div class="page-form">
        <div class="body-content">
            <div id="lock-screen-avatar"><img src="../../images/128.jpg" alt="" class="img-responsive img-circle">
            </div>
            <div id="lock-screen-info">
                <h1>蜗牛</h1>
                <div class="email">xxx123@xxx.com</div>
                <form action="../home/home.html" class="mtl mbl">
