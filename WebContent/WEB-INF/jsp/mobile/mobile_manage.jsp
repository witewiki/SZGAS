	                                        ...
	                                        <table id="example1" style="border-bottom:1px solid #ddd" class="table table-striped table-bordered table-hover text-center">
	                                            <thead>
	                                                <tr>
	                                                    ...
	                                                    <td><strong>下载地址</strong></td>
	                                                    <td><strong>当前下载量</strong></td>
	                                            ...
	                                            <tbody>
	                                                <tr class="odd gradeX">
	                                                    <td>燃气手机客户端</td>
	                                                    <td>http://www.szrq/web/store/app/szrq_mobile.apk</td>
	                                                    <td>999999999</td>
	                                                    <td><span class="label label-sm label-success">上架</span></td>
	                                                    <td>
	                                                ...
	                                                <tr class="odd gradeX">
	                                                    ...
	                                                    <td>http://www.szrq/web/store/app/szrq_mobile.apk</td>
	                                                    <td>999999999</td>
	                                                    <td><span class="label label-sm label-grey">下架</span></td>
	                                                    <td>
	                                                    	<a href="javascript:;">详情</a>
