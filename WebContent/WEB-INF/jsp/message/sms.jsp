				...
				<div id="page-wrapper">
	                ...
	                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
	                    ...
	                    <ol class="breadcrumb page-breadcrumb">
	                        ...
	                        <li class="active"><i class="fa fa-envelope"></i>&nbsp;短信</li>
	                    </ol>
	                    <div class="clearfix"></div>
	                </div>
	                                ...
	                                <div class="portlet box portlet-white">
	                                    ...
	                                    <div class="portlet-body">
	                                        <form role="form-horizontal" method="post">
	                                            ...
	                                            <div class="form-group compose-editor mbl">
	                                                <textarea rows="6" class="wysihtml5 form-control" placeholder="输入内容"></textarea>
	                                            </div>
	                                            <hr/>
	                                            <div class="form-group compose-btn navbar-right">
