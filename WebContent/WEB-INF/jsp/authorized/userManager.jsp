				...
				<div id="page-wrapper">
	                ...
	                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
	                    ...
	                    <ol class="breadcrumb page-breadcrumb">
	                        ...
	                        <li class="active"><i class="fa fa-eye"></i>&nbsp;用户授权</li>
	                    </ol>
	                    <div class="clearfix"></div>
	                </div>
	                                        ...
	                                        <table id="example1" style="border-bottom:1px solid #ddd" class="table table-striped table-bordered table-hover text-center">
	                                            ...
	                                            <tbody>
	                                                <tr class="odd gradeX">
	                                                    ...
	                                                    <td><a href="javascript:;">查看角色</a></td>
		                        ...
		                        <div class="modal-dialog">
		                            <div class="modal-content">
		                                <div class="modal-header modal-header-primary">
		                                    ...
		                                    <h4 id="modal-header-primary-label" class="modal-title">新增用户</h4>
		                                </div>
		                                <div class="modal-body">
	                                        <div class="form-group">
                                        		<label for="username" class="col-md-2 control-label text-right">用户名称</label>
	                                            <div class="col-md-10">
	                                        ...
	                                        <div class="form-group">
                                        		<label for="password" class="col-md-2 control-label text-right">用户密码</label>
	                                            <div class="col-md-10">
                                                    <div class="input-icon">
	                                        ...
	                                        <div class="form-group">
                                        		<label for="auth" class="col-md-2 control-label text-right">授权</label>
	                                            <div class="col-md-10">
                                                    <div class="input-icon">
			                                            <select id="auth" class="select2" style="width:50%;">
	                                        ...
	                                        <div class="form-group">
	                                            <label for="add_user_form_status_select" class="col-md-2 control-label text-right">状态</label>
	                                            <div class="col-md-10">
                                                    <div class="input-icon">
			                                            <select id="add_user_form_status_select" class="select2" style="width:50%;">
